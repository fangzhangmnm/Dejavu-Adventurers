...
label city_gate:
    ...
    $ Guard=PlayerCharacter("Captain Galen")
    ...
    $ characters([Guard, Player,Aqua,2.0])

    opening_dialogue "Opening"

    narrator_dejavu "The player approaches the city gate, the gate is closed shut. The guard is standing in front of the gate."
    ...
    narrator_dejavu "Player presents the party's documents to Captain Galen. The documents are signed and stamped by the proper authorities."
    ...
    narrator_dejavu "Player offers a pouch of gold to Captain Galen."
    ...
    narrator_dejavu "Player presents the letter to Captain Galen."
    ...
    end_dialogue "A failed persuasion which leads to a fight"
