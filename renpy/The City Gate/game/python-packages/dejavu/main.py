...
def compose_roleplay_request(character_name,scenario_data,history=[]):
    ...
    request=[]
    prompt="Write {character_name}'s next reply in a fictional chat. Write 1 reply in 1 to 2 lines. Be proactive, creative, and drive the plot and conversation forward. Do not assume player had taken the action unless explicitly told. Always stay in character and avoid repetition. \n\n{character_description}\n\n{character_name}'s personality: {character_personality}\n\nCircumstances and context of the dialogue: {scenario_summary}".format(
